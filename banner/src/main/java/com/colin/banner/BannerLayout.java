...
import com.colin.banner.layoutmanager.BannerLayoutManager;
import com.colin.banner.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        if (mSelectedDrawable == null) {
            ...
            selectedGradientDrawable.setColor(Color.parseColor("#ffffff"));
            selectedGradientDrawable.setSize(dp2px(8), dp2px(8));
            selectedGradientDrawable.setCornerRadius(dp2px(8) / 2);
        ...
        if (mUnselectedDrawable == null) {
            ...
            unSelectedGradientDrawable.setColor(Color.parseColor("#CCCCCC"));
            unSelectedGradientDrawable.setSize(dp2px(8), dp2px(8));
            unSelectedGradientDrawable.setCornerRadius(dp2px(8) / 2);
