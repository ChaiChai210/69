...
import com.colin.tomvod.adapter.AnnouncementAdapter;
...
public class AnnouncementFragment extends BaseFragment {
    ...
    protected void initAllMembersView(Bundle savedInstanceState) {
        adapter = new AnnouncementAdapter(noticebeans);
    ...
    private void getNotice() {
        ...
        OkGo.<String>get(URLs.NOTICE).params(httpParams).execute(new StringCallback() {
            ...
            public void onSuccess(Response<String> response) {
                ...
                Type type = new TypeToken<BaseListBean<Noticebean>>() {
                }.getType();
                BaseListBean<Noticebean> searchHotBeanBaseListBean = GsonHelper.gson.fromJson(response.body(), type);
