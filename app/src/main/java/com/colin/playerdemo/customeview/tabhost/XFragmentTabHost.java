package com.colin.playerdemo.customeview.tabhost;
...
public class XFragmentTabHost extends CustomTabHost {
    ...
    private void _init(Context context) {
        ...
        mContext = context;
        mTextActiveColor = ContextCompat.getColor(mContext, R.color.colorInactive);
        mTextInactiveColor = ContextCompat.getColor(mContext, R.color.core_common_text_gray);
    ...
    public void addTabItem(TabItem item, Class<?> fragClass, Bundle bundle) {
        ...
        if(bundle.getInt("num")==2){
            home_num_tv.setVisibility(GONE);
        }
