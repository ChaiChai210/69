...
public class HomeType3Adapter extends BaseQuickAdapter<MainBean.VideoBean.ListBean, BaseViewHolder> {
    public HomeType3Adapter(@Nullable List<MainBean.VideoBean.ListBean> data) {
