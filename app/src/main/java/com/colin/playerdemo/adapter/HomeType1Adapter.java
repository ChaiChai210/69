...
public class HomeType1Adapter extends BaseQuickAdapter<MainBean.VideoBean.ListBean, BaseViewHolder> {
    public HomeType1Adapter(@Nullable List<MainBean.VideoBean.ListBean> data) {
        super(R.layout.home_item_1,data);
    }
