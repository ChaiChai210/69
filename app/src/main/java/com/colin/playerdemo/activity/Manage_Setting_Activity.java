...
import com.colin.playerdemo.popwindows.Name_Popwindows;
import com.colin.playerdemo.popwindows.PhotoPopWindow;
import com.colin.playerdemo.popwindows.Sex_PopupWindows;
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.change_name_layout:
                ...
                break;
            case R.id.quit_tv:
                U_Set_activity u_set_activity = new U_Set_activity();
