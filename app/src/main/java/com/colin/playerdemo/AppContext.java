...
//                    boolean isNetConnected = NetworkUtils.isHaveInternet();
//                    if (isNetConnected) {
...
//            headers.put ("app-token", Tools.getSharedPreferencesValues (this, "token"));
//        }else  if (!Tools.isEmpty (Tools.getSharedPreferencesValues (this, "app-token"))) {
//            headers.put ("app-token", Tools.getSharedPreferencesValues (this, "app-token"));
//        }
//
...
//        OkGo.getWithToken ().init (this)                           //必须调用初始化
